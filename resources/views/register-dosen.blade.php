            ...
            <div class="hidden lg:flex items-center justify-center bg-[#d5c7a3] p-8 h-full">
                 <div class="text-center text-white">
                    {{-- <x-filament::icon icon="heroicon-o-academic-cap" class="w-24 h-24 mx-auto text-white mb-4" /> --}}
                      ...
                      <p class="text-2xl font-semibold">Halo Dosen!</p> 
                      <p class="mt-2 text-base opacity-90">Daftarkan diri Anda dan kelola aktivitas belajar mengajar.</p> 
                 </div>
            </div>
 
            <div class="bg-[#f2e2b1] p-8 flex items-center justify-center w-full">
                 <div class="w-full max-w-md">
                      <h2 class="text-3xl font-bold mb-8 text-center text-gray-800">Daftar Akun Dosen</h2>
